...
#     output_dir="../../model/fjw/model_ESIM_wv200_"+str(fold+1)+"/"
...
train_gender_preds.shape,train_age_preds.shape,test_gender_preds.shape
...
pk.dump(outputs_dict,open("../../var/fjw/model_ret_dicts/"+output_dir.strip().split("/")[-2][:-2]+".pk","wb"))
