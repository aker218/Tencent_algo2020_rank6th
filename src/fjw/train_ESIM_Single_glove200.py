...
class DotProductAttention(nn.Module):
    def __init__(self,hidden_size=100,dropout=0):
...
#                                         bidirectional=True)
        ...
        self._attention =DotProductAttention(self.hidden_size*2)
...
#     output_dir="../../model/fjw/model_ESIM_glove200_"+str(fold+1)+"/"
    output_dir="../../model/fjw/model_ESIM_Single_glove200_"+str(fold+1)+"/"
    card_list=[0,2,3]
...
#         model.load_state_dict(torch.load(os.path.join(output_dir,"checkpoint-23048","model.pt")))
        ...
        train(args,train_dataset,eval_dataset,temp_dataset,model,8)
    else:
...
train_gender_preds.shape,train_age_preds.shape,test_gender_preds.shape,test_age_preds.shape
